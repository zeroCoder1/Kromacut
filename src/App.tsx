                            ...
                            <>
                                ...
                                <div className="controls-scroll">
                                    ...
                                    <ControlsPanel
                                        ...
                                        onApply={() =>
                                            applyQuantize(canvasPreviewRef)
                                        }
                                ...
                                onClick={async () => {
                                    if (mode === "3d") {
                                        ...
                                        try {
                                            ...
                                            alert(
                                                "Model too large for binary STL in memory."
                                            );
                                        ...
                                        const headerStr =
                                            "StrataPaint Binary STL";
                                        for (
                                            let i = 0;
                                            i < headerStr.length && i < 80;
                                            i++
                                        )
                                            view.setUint8(
                                                i,
                                                headerStr.charCodeAt(i)
                                            );
                                        view.setUint32(
                                            headerBytes,
                                            totalTris,
