      ...
      if (adjustments && !isAllDefault(adjustments)) {
        ...
        if (sig !== lastAdjSigRef.current) {
          try {
            ...
            const iw2 = baseSource instanceof HTMLImageElement ? baseSource.naturalWidth : iw;
            const ih2 = baseSource instanceof HTMLImageElement ? baseSource.naturalHeight : ih;
    ...
    return (
      <div
        ...
        style={
          showCheckerboard
            ? {
                background: 'repeating-conic-gradient(#666 0% 25%, #333 0% 50%) 50% / 16px 16px',
              }
            : undefined
        }
      >
        ...
        {isCropMode && selection ? (
          ...
          >
            ...
            >
              ...
              {/* corners */}
              <div className="corner nw" data-handle="nw" onMouseDown={onSelectionPointerDown} />
              <div className="corner ne" data-handle="ne" onMouseDown={onSelectionPointerDown} />
              <div className="corner sw" data-handle="sw" onMouseDown={onSelectionPointerDown} />
              <div className="corner se" data-handle="se" onMouseDown={onSelectionPointerDown} />
              {/* side handles */}
              <div className="side n" data-handle="n" onMouseDown={onSelectionPointerDown} />
              <div className="side s" data-handle="s" onMouseDown={onSelectionPointerDown} />
              <div className="side w" data-handle="w" onMouseDown={onSelectionPointerDown} />
              <div className="side e" data-handle="e" onMouseDown={onSelectionPointerDown} />
            </div>
          </div>
        ) : null}
      </div>
